...
int init(uint64_t event_engine, uint64_t io_engine, const PhotonOptions& options) {  // io_engine代表啥
...
#ifdef __linux__
    INIT_IO(LIBAIO, libaio_wrapper, options.libaio_queue_depth)   // libaio_wrapper_init()
